...
**Placeholder** — When the editor is empty, a prompt reads *"Start typing or generate with AI"*. Click the blue link to open the [AI Assistant](#ai-assistant) with your cursor focus.
