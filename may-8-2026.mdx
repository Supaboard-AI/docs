...
Over the past few months, our engineering team rebuilt the core engine of Supaboard to improve speed, performance and workload management. 
The result: query and processing speeds are now up to 50x faster across the platform. Dashboards that used to take seconds to load now feel instant, and heavy workloads that previously slowed things down scale far more gracefully.
...
Read more about it [here](/ignore-filtering-for-a-given-table)
